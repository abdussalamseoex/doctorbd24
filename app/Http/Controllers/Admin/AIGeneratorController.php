...
class AIGeneratorController extends Controller
{
    ...
    private function buildPrompt($type, $context)
    {
        ...
        $defaults = [
            ...
            'hospital_bio' => "You are an expert SEO copywriter for a premium healthcare directory. Write a comprehensive, highly SEO-optimized, and informative overview for the medical facility named '{name}', located at '{address}'. STRICT RULE: Write entirely in the third-person perspective (use 'They', 'The hospital', 'The facility'). NEVER use first-person words like 'we', 'our', or 'us', because this is a third-party directory listing. Provide a strong keyword-rich introduction, detail their modern medical services, equipment, and patient care approach, and explain why patients trust this facility. Use professional HTML formatting and attractive headings.",
