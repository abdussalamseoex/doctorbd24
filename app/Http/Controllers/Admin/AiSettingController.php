...
class AiSettingController extends Controller
{
    ...
    {
        $keys = [
            'ai_provider', 'openai_api_key', 'gemini_api_key', 'anthropic_api_key', 'anthropic_model', 'openai_base_url', 'openai_model',
