        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/4 flex-shrink-0">
                <div class="sticky top-24 space-y-5">
                    ...
                    @if($sidebarTopAd)
                        <div class="mb-5 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700">
                            {!! $sidebarTopAd->ad_code !!}
                        </div>
                    @endif

                    @if($sidebarBottomAd)
                        <div class="mb-5 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700">
                            {!! $sidebarBottomAd->ad_code !!}
                        </div>
                    @endif
                </div>
