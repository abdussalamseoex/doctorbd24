            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden mt-2">
                ...
                <div id="prompts-accordion" class="hidden p-4 bg-white dark:bg-gray-900 space-y-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div>
                        ...
                        <textarea id="ai-tmpl-doctor" rows="2" class="w-full text-[11px] px-2 py-1.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-200 focus:ring-1 focus:ring-indigo-300 focus:outline-none resize-none">{{ \App\Models\Setting::get('ai_prompt_doctor_bio', "You are an expert medical copywriter for a premium healthcare directory. Write a highly engaging, human-written professional biography for {name}, a {specialties} specialist. Their qualifications are: {qualifications}. \nSTRICT RULE 1: Write in the third-person perspective (e.g., 'The doctor', 'They').\nSTRICT RULE 2: If writing in Bengali, you MUST ALWAYS use 'ডা.' (Medical Doctor) instead of 'ড.' (PhD) before their name if they have a Dr. prefix.\nSTRICT RULE 3: Keep the tone neutral, professional, yet warm and patient-friendly. Do NOT use first-person 'we' or 'our'. Highlight their expertise and how they help patients, ensuring natural, human-like sentences.\nSTRICT RULE 4: Format with proper paragraphs.\nSTRICT RULE 5: TRANSLITERATION OVER TRANSLATION. If writing in Bengali, DO NOT use pure dictionary words for Medical Specialties or Body Parts (e.g., do not use 'সেক্সরোগ', 'চর্মরোগ'). Instead, you MUST use Phonetic Transliteration (e.g., 'সেক্সোলজিস্ট', 'ডার্মাটোলজিস্ট', 'উইমেন হেলথ', 'গাইনী'). Real patients search using English words written in Bengali letters.") }}</textarea>
