        ...
        <div class="mt-4 flex justify-between items-center bg-gray-100 dark:bg-gray-900/50 p-2 rounded-xl">
            <div class="flex items-center gap-2">
                <button type="button" wire:click="$toggle('showMapView')" 
                        ...
                        :class="@js($showMapView) ? 'bg-emerald-500 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 hover:bg-emerald-50'">
            ...
            @if($search || $type || $division || $district || $area || $verified || $userLat)
