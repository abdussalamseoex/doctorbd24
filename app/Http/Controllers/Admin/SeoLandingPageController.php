...
class SeoLandingPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'meta_title.bn' => 'nullable|string',
            'meta_description' => 'nullable',
            'meta_description.en' => 'nullable|string',
            'meta_description.bn' => 'nullable|string',
            'content_top' => 'nullable',
            'content_top.en' => 'nullable|string',
            'content_top.bn' => 'nullable|string',
            'content_bottom' => 'nullable',
            'content_bottom.en' => 'nullable|string',
            'content_bottom.bn' => 'nullable|string',
