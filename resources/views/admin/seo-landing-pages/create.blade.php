...
@section('title', 'Create Programmatic SEO Landing Page')
...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create SEO Landing Page</h1>
            <p class="text-sm text-gray-500">Target a specific geographic and specialty keyword.</p>
        </div>
    </div>

    <form action="{{ route('admin.seo-landing-pages.store') }}" method="POST" class="space-y-6">
        @csrf
        @include('admin.seo-landing-pages._form')
    </form>
</div>
@endsection
